...
function Hero() {
  return (
    <div 
     ...
     className="2xl:pb-[32rem] 2xl:pr-[56rem] xl:pb-72 xl:pr-[45rem] lg:pl-40 lg:pr-[38rem] md:pt-32 md:pb-28 md:px-48 lg:bg-[url('../../../resources/assets/home/desktop/image-hero.jpg')] w-full pt-28 pb-24 px-4 sm:bg-[url('../../../resources/assets/home/tablet/image-header.jpg')] bg-cover bg-center bg-no-repeat">
